...
def eval_mesh(test_mesh, res_dir, ref_dir, reffile_prefix='mesh', resfile_prefix='pred'):
        ...
        # reconstruct_file = open('./3DFAW/view_data_f/'+test_mesh+'rec.obj','w')
        # gt_file = open('./3DFAW/view_data_f/'+test_mesh+'gt.obj','w')
...
def eval_meshes(test_list, res_dir, ref_dir):
    ...
    txtfile = open("./3DFAW/test/result_finetune.txt",'w')
